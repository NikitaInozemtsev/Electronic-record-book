...
import server.services.DisciplineService;

import java.util.List;
import java.util.Optional;

@Controller
@RequestMapping(value = "api/${version.api}/disciplines")
public class DisciplineController {
    ...
    @PostMapping(value = "/")
    public ResponseEntity<String> create(@RequestBody DisciplineDto dto) {
        Optional<Exception> result = service.createDiscipline(dto);
        if (result.isEmpty()) {
    ...
    @PutMapping(value = "/")
    public ResponseEntity<String> update(@RequestBody DisciplineDto dto) {
